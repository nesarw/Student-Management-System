...
if (strlen($_SESSION['sturecmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
    {
        ...
        $ret="select UserName from tbladmin where UserName=:UserName|| AdminName=:AdminName";
        ...
        if($query->rowCount() == 0)
        {
            ...
            echo "<script>alert('Username or Teacher already exist. Please try again');</script>";
        }
    }
}
?>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="MobileNumber" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
