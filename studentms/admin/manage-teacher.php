                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Teacher Nmae</th>
                            <th class="font-weight-bold">Teacher Mobile Number</th>
                            <th class="font-weight-bold">Teachers Email</th>
...
$sql="SELECT tbladmin.ID as sid,tbladmin.AdminName,tbladmin.MobileNumber,tbladmin.Email from tbladmin ";
$query = $dbh -> prepare($sql);
$query->execute();
