...
$sql="insert into tblstudent(StudentName,StudentEmail,StudentClass,Gender,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,maths,dlco,ds,dsgt,cg,java,amaths,adlco,ads,adsgt,acg,ajava,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:maths,:dlco,:ds,:dsgt,:cg,:java,:amaths,:adlco,:ads,:adsgt,:acg,:ajava,:uname,:password,:image)";
...
$query->bindParam(':amaths',$maths,PDO::PARAM_STR);
$query->bindParam(':adlco',$dlco,PDO::PARAM_STR);
$query->bindParam(':ads',$ds,PDO::PARAM_STR);
$query->bindParam(':adsgt',$dsgt,PDO::PARAM_STR);
$query->bindParam(':acg',$cg,PDO::PARAM_STR);
$query->bindParam(':ajava',$java,PDO::PARAM_STR);
$query->bindParam(':uname',$uname,PDO::PARAM_STR);
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="dlco" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">DS</label>
                        <input type="text" name="ds" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">DSGT</label>
                        <input type="text" name="dsgt" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">CG</label>
                        <input type="text" name="cg" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">JAVA</label>
                        <input type="text" name="java" value="" class="form-control" required='true'>
                      </div>
                      <h3>Attendance details</h3>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For Maths</label>
                        <input type="text" name="amaths" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For DLCO</label>
                        <input type="text" name="adlco" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For DS</label>
                        <input type="text" name="ads" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For DSGT</label>
                        <input type="text" name="adsgt" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For CG</label>
                        <input type="text" name="acg" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Attendance For JAVA</label>
                        <input type="text" name="ajava" value="" class="form-control" required='true'>
                      </div>
                      <h3>Login details</h3>
                      <div class="form-group">
